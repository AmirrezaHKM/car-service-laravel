...
<div class="container mx-auto mt-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="text-center">
        <a href="{{ route('mechanicpanel.tickets.index') }}" class="inline-block my-4 text-center w-[200px] bg-blue-600 text-white px-4 py-2 rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200">بازگشت به لیست تیکت‌ها</a>
    </div>
</div>
@endsection
