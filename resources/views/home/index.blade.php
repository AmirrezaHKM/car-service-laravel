...
@section('content')
    <section
        class="relative flex flex-col justify-center items-center text-center px-4 py-24 bg-gradient-to-br from-indigo-900 to-indigo-600 fade-in overflow-hidden">
        <img src="{{ asset('images/repair-shop.webp') }}" alt="تعمیرگاه"
        ...
        <div class="relative z-10 max-w-3xl text-white">
            ...
            <p class="text-lg leading-relaxed mb-8 drop-shadow-md">
                با سامانه ما می‌توانید نوبت‌های تعمیر را آسان‌تر رزرو کنید، درخواست‌های مشتریان را مدیریت کرده و با پشتیبانی
                در ارتباط باشید.
            </p>
            <a href="{{ route('services.list') }}"
                class="inline-block bg-yellow-400 text-indigo-900 font-bold px-8 py-3 rounded-full shadow-lg hover:bg-yellow-500 transition">
                شروع کنید
            </a>
        </div>
    </section>
    ...
    <section class="my-10 px-4">
        ...
        <div class="text-center mt-6">
            <a href="{{ route('services.list') }}"
                class="inline-block bg-indigo-700 text-white px-6 py-3 rounded hover:bg-indigo-800 transition">مشاهده همه
                خدمات</a>
        </div>
    </section>
    ...
    <section class="my-10 px-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
            @foreach ($repairmen as $repairman)
                <div
                    class="bg-white rounded-2xl shadow-lg p-6 hover:shadow-2xl transition transform hover:-translate-y-1 cursor-pointer flex flex-col justify-between text-center">
                    <div>
                    ...
                    <div class="mt-auto">
                        <a href="{{ route('repairmen.profile', $service->repairman->id) }}">
                            <button
                                class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 rounded-lg shadow-md transition duration-300 ease-in-out">
                                مشاهده پروفایل
                            </button>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
                <div class="bg-indigo-50 p-6 rounded-lg shadow hover:shadow-md transition">
                    ...
                    <p class="text-sm text-gray-600">مشتریان می‌توانند نوبت‌های خود را به صورت آنلاین رزرو و مدیریت کنند.
                    </p>
                </div>
                <div class="bg-indigo-50 p-6 rounded-lg shadow hover:shadow-md transition">
                    <div class="text-indigo-700 text-3xl mb-3">🛠</div>
