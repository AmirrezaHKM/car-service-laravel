...
<div class="container mx-auto p-6 max-w-xl">
    ...
    <form action="{{ route('admin.services.update', $service->id) }}" method="POST" class="bg-white p-6 rounded-lg shadow-sm space-y-4">
        @csrf
        @method('PUT')
        ...
        <div class="mt-4">
            <a href="{{ route('admin.services.index') }}" class="inline-block w-full text-center bg-blue-600 text-white px-4 py-2 rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200">
